<x-layout title="Add Service">
<div class="flex items-center justify-between mb-6">
    <div>
        <h1 class="text-3xl font-bold text-gray-900">Add Service</h1>
        <p class="text-gray-600 mt-1">Create a new service customers can book.</p>
    </div>
...
<div class="bg-white shadow rounded-2xl border p-6">
    <form method="POST" action="/admin/services" class="space-y-5">
        @csrf
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
                ...
                <input type="number" name="duration_minutes" value="{{ old('duration_minutes', 30) }}" required min="5" max="480"
                       class="w-full rounded-xl border-gray-300 focus:border-gray-900 focus:ring-gray-900 px-4 py-2">
            </div>
